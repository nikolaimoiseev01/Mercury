<section class="py-28 content flex gap-28">
    <div class="flex flex-col">
        <h2 class="mb-14">Проекты</h2>
    ...
    <div class="flex flex-col gap-10 flex-1">
        <div class="grid grid-cols-2 gap-5">
            @foreach($projects as $project)
                <a class="min-h-80 relative span-col-1 flex items-center justify-center group overflow-hidden">
        ...
        @if(count($projects) < $cnt_total)
            <a wire:click="loadMore">Загрузить еще</a>
        @endif
    </div>
</section>
